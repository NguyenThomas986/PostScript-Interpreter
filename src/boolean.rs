...
mod tests {
    ...
    #[test]
    fn test_eq_strings() {
        let mut s = stack_with(vec![Value::Str("hi".to_string()), Value::Str("hi".to_string())]);
        s.op_eq().unwrap();
        assert_eq!(s.pop().unwrap(), Value::Bool(true));
    }
    ...
    #[test]
    fn test_eq_names() {
        let mut s = stack_with(vec![Value::Name("foo".to_string()), Value::Name("foo".to_string())]);
        s.op_eq().unwrap();
        assert_eq!(s.pop().unwrap(), Value::Bool(true));
    }
    ...
    fn test_cvs_string_passthrough() {
        let mut s = stack_with(vec![Value::Str("hi".to_string()), Value::Str(String::new())]);
        s.op_cvs().unwrap();
    ...
    #[test]
    fn test_cvs_name() {
        let mut s = stack_with(vec![Value::Name("foo".to_string()), Value::Str(String::new())]);
        s.op_cvs().unwrap();
